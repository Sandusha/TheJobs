...
public class UserControllerTests {
    ...
    @Test
    public void testBookAppointment_Success() throws LoginException, AppointmentException, ConsultantException, IOException, TimeDateException, MessagingException {
